...
from utils.ModelConfigParser import ModelConfigParser
...
class Darknet(nn.Module):
    def __init__(self, config_path, img_size=416):
        ...
        self.__config_parser = ModelConfigParser(config_path)
        self.module_defs = self.__config_parser.parse()
        self.hyperparams, self.module_list = self.__create_modules()
    ...
    def __create_modules(self):
        ...
        for module_i, module_def in enumerate(self.module_defs):
            ...
            # Register module list and number of results filters
